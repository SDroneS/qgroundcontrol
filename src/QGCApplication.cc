...
void QGCApplication::_initCommon(void)
{
    ...
    SDSController sds_flag_reader = new SDSController();
}
...
{
    MyWorker *workerThread = new MyWorker(this);
